...
public class BucketSort{
	public static void main(String args[])
	{
		...
		List<String> myList =  Arrays.asList("Anish","Rahul","arush","Anish","Rahul","arush","Anish","Rahul","arush","Anish","Rahul","arush","Anish","Rahul","arush","Anish","Rahul","arush","Anish","Rahul","arush","Anish","Rahul","arush","Anish","Rahul","arush","Anish","Rahul","arush");
	...
	/**
	 * Function sorts the elementList. If elementList is more than 10 elements then it performs bucket sort else sorts with Insertion Sort.
	 */
	public static void sort(List<String> elementList,int depth) {
		//Perform Bucket sort
		//Create Buckets and fill them with relevant data each bucket has a list of strings
		...
		if(elementList.size()>10) {
			...
			for(Character key: bucketList.keySet()) {
				...
				if(key!='\0') {
					...
					sort(subElementList.subList((int)Math.ceil(subElementList.size()/2), subElementList.size()), depth);
				}
			}
		}else {
